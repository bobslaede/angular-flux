...
function Host(id, val, storage) {
    ...
    this.clock = new clock_fn(this._id); // TODO handshake, offset
...
},{"./Pipe":5,"./SecondPreciseClock":8,"./Spec":11,"./Syncable":13,"./env":16}],2:[function(require,module,exports){
"use strict";
...
},{"./Host":1,"./LongSpec":3,"./Model":4,"./Pipe":5,"./ReactMixin":7,"./Set":9,"./SharedWebStorage":10,"./Spec":11,"./Storage":12,"./Syncable":13,"./Vector":14,"./WebSocketStream":15,"./env":16}],3:[function(require,module,exports){
"use strict";
...
},{"./Spec":11}],4:[function(require,module,exports){
"use strict";
...
},{"./Spec":11,"./Syncable":13}],5:[function(require,module,exports){
"use strict";
...
},{"./Spec":11,"./env":16}],6:[function(require,module,exports){
"use strict";
...
},{"./Spec":11,"./env":16}],8:[function(require,module,exports){
"use strict";
...
},{"./Spec":11}],9:[function(require,module,exports){
"use strict";
...
},{"./Model":4,"./Spec":11,"./Syncable":13,"./env":16}],10:[function(require,module,exports){
"use strict";
...
function SharedWebStorage(usePersistentStorage) {
    ...
    this.tails = {};
    this.store = usePersistentStorage ? localStorage : sessionStorage;
...
},{"./Host":1,"./Spec":11,"./Syncable":13,"./env":16}],11:[function(require,module,exports){
"use strict";
...
},{"./Host":1,"./Syncable":13}],13:[function(require,module,exports){
"use strict";
...
Syncable.memberClasses = {ops:1,neutrals:1,remotes:1,defaults:1,reactions:1};
Syncable._default = {};
...
Syncable.extend = function (fn, own) {
    ...
    for(var key in defs) {
        ...
        if (val && val.constructor===Function) {
            defs[key] = {type:val, value:undefined};
        } else {
            defs[key] = {type:null, value: val};
        }
    }
    ...
    ops: {
        ...
        init: function (spec, state, src) {
            ...
            while (a_spec = specs.pop()) {
                this.deliver(typeid.add(a_spec), tail[a_spec], src);
            }
...
},{"./Spec":11,"./env":16}],14:[function(require,module,exports){
"use strict";
...
module.exports = Syncable.extend('Vector', {
    ...
    getParentOf: function (id) {
        ...
        if (!spec) { throw new Error('operation unknown: '+id); }
...
},{"./LongSpec":3,"./ProxyListener":6,"./Spec":11,"./Syncable":13}],15:[function(require,module,exports){
"use strict";
...
},{"./env":16}],16:[function(require,module,exports){
"use strict";
